...
const PostDetailPage: React.FC = () => {
  ...
  const handleTabChange = (tab: 'post' | 'summarise' | 'planner') => {
    ...
    // Only fetch planner data if it hasn't been fetched yet and we're on the planner tab
    if (tab === 'planner' && post && userStats && !studyPlan && !isPlannerLoading && !plannerCalledRef.current) {
